                        ...
                        <tbody>
                            {data?.map((user) => (
                                <tr key={user._id}>
                                    ...
                                    <td className="border px-4 py-2">
                                        <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded" disabled={user.verified === true} onClick={() => verifyUserHandler(user._id)}>
                                            Doğrula
                                        </button>
                                    </td>
                                    <td className="border px-4 py-2">
                                        <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onClick={() => deleteUserHandler(user._id)}>
                                            Sil
                                        </button>
                                    </td>
                                </tr>
