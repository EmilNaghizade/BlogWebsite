...
const SuggestedPosts = ({ className, header, posts = [], tags }) => {
  return (
    ...
    >
        ...
        {posts.slice(0, 10).map((item) => (
          ...
          >
            ...
            <div className="text-sm text-dark-hard font-medium">
              <h3 className="text-xs text-dark-hard font-medium md:text-base lg:text-lg">
      ...
      <h2 className="font-medium text-dark-hard mt-8 md:text-xl">Etiketler</h2>
      {tags.length === 0 ? (
        <p className="text-slate-500 text-xs mt-2">Bu yazıya ait bir etiket bulunamadı.</p>
      ) : (
